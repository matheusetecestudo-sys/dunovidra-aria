        ...
        {isMobileMenuOpen && (
          <>
            ...
            <motion.div 
              ...
              className="fixed top-0 right-0 h-screen w-[85%] max-w-[340px] bg-slate-900/95 text-white border-l border-slate-800/80 z-50 md:hidden flex flex-col p-8 pt-24 shadow-2xl justify-between"
            >
              <div className="flex flex-col gap-6">
                <div className="border-b border-slate-800 pb-4 mb-4">
                  <span className="font-display font-black text-2xl tracking-[0.25em] text-blue-500">DUNO</span>
                  <div className="text-xs text-slate-400 mt-1 uppercase tracking-widest font-mono">ENGENHARIA DE VIDROS</div>
                </div>
                ...
                <div className="flex flex-col gap-4">
                  {navLinks.map((link, idx) => (
                    <motion.a 
                      ...
                      onClick={() => setIsMobileMenuOpen(false)}
                      className="text-lg font-medium text-slate-200 hover:text-blue-400 py-2 border-b border-slate-800/55 transition-colors"
                    >
                      {link.name}
                    </motion.a>
                  ))}
              ...
              >
                <a 
                  ...
                  rel="noopener noreferrer"
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="btn-whatsapp group justify-center text-center py-3.5 flex items-center gap-2 text-sm font-semibold rounded-full bg-green-500 hover:bg-green-600 text-white transition-colors"
                >
...
const Services = () => {
  const residentialServices = [
    { 
      ...
      img: '/imagens_banner/vidracaria_servico_1.png',
    ...
    { 
      ...
      img: '/imagens_banner/vidracaria_servico_2.png',
    ...
    { 
      ...
      img: '/imagens_banner/vidracaria_servico_3.png',
    ...
    { 
      ...
      img: '/imagens_banner/vidracaria_servico_4.png',
  ...
  const commercialServices = [
    { 
      ...
      img: '/imagens_banner/fachada_de_vidro.png',
    ...
    { 
      ...
      img: '/imagens_banner/vidracaria_servico_6.png',
    ...
    { 
      ...
      img: '/imagens_banner/vidracaria_servico_7.png',
    ...
    { 
      ...
      img: '/imagens_banner/vidracaria_servico_8.png',
